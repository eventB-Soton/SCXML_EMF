 ...
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getAny <em>
 * Any</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getRaise
 * <em>Raise</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getIf <em>
 * If</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getForeach
 * <em>Foreach</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getSend
 * <em>Send</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getScript
 * <em>Script</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getAssign
 * <em>Assign</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getLog <em>
 * Log</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getCancel
 * <em>Cancel</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getArray
 * <em>Array</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getIndex
 * <em>Index</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlForeachType#getItem
 * <em>Item</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType()
...
public interface ScxmlForeachType extends EObject {
     ...
     *         attribute list.
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_ScxmlCoreExecutablecontent()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Raise()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_If()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Foreach()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Send()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Script()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Assign()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Log()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Cancel()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see #setArray(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Array()
     ...
     * @see #setIndex(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Index()
     ...
     * @see #setItem(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_Item()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlForeachType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
