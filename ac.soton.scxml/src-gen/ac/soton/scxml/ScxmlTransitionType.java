 ...
 * <li>{@link ac.soton.scxml.ScxmlTransitionType#getAny
 * <em>Any</em>}</li>
 * <li>
 * {@link ac.soton.scxml.ScxmlTransitionType#getRaise
 * <em>Raise</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlTransitionType#getIf
 * <em>If</em>}</li>
 * <li>
 * {@link ac.soton.scxml.ScxmlTransitionType#getForeach
 * <em>Foreach</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlTransitionType#getSend
 * <em>Send</em>}</li>
 * <li>
 ...
 * <em>Assign</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlTransitionType#getLog
 * <em>Log</em>}</li>
 * <li>
 * {@link ac.soton.scxml.ScxmlTransitionType#getCancel
 * <em>Cancel</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlTransitionType#getCond
 * <em>Cond</em>}</li>
 * <li>
 ...
 * <em>Target</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlTransitionType#getType
 * <em>Type</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType()
...
public interface ScxmlTransitionType extends EObject {
     ...
     *         attribute list.
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_ScxmlCoreExecutablecontent()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Raise()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_If()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Foreach()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Send()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Script()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Assign()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Log()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Cancel()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see #setCond(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Cond()
     ...
     * @see #setEvent(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Event()
     * @model
     *        dataType="ac.soton.scxml.EventTypesDatatype"
     ...
     * @see #setTarget(List)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Target()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_Type()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlTransitionType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
