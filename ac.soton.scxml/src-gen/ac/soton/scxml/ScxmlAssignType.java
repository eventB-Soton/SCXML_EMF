 ...
 * <ul>
 * <li>{@link ac.soton.scxml.ScxmlAssignType#getMixed
 * <em>Mixed</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlAssignType#getAny <em>
 * Any</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlAssignType#getAttr <em>
 * Attr</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlAssignType#getExpr <em>
 * Expr</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlAssignType#getLocation
 * <em>Location</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlAssignType#getType <em>
 * Type</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType()
...
public interface ScxmlAssignType extends EObject {
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_Mixed()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see #setAttr(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_Attr()
     ...
     * @see #setExpr(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_Expr()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_Location()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_Type()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlAssignType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
