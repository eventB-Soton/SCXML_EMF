 ...
 * <em>Onentry</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParallelType#getOnexit
 * <em>Onexit</em>}</li>
 * <li>
 * {@link ac.soton.scxml.ScxmlParallelType#getTransition
 * <em>Transition</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParallelType#getState
 * <em>State</em>}</li>
 * <li>
 ...
 * <em>Datamodel</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParallelType#getInvoke
 * <em>Invoke</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParallelType#getAny
 * <em>Any</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParallelType#getId <em>
 * Id</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType()
...
public interface ScxmlParallelType extends EObject {
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_ScxmlParallelMix()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Onentry()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Onexit()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     *         list.
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Transition()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_State()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Parallel()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_History()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Datamodel()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Invoke()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see #setId(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_Id()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParallelType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
