 ...
 * <ul>
 * <li>{@link ac.soton.scxml.ScxmlDataType#getMixed <em>
 * Mixed</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlDataType#getAny <em>Any
 * </em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlDataType#getExpr <em>
 * Expr</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlDataType#getId <em>Id
 * </em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlDataType#getSrc <em>Src
 * </em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType()
...
public interface ScxmlDataType extends EObject {
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType_Mixed()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see #setExpr(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType_Expr()
     ...
     * @see #setId(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType_Id()
     ...
     * @see #setSrc(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType_Src()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlDataType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
