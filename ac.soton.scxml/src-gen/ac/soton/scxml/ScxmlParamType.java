 ...
 * <li>{@link ac.soton.scxml.ScxmlParamType#getAny <em>
 * Any</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParamType#getExpr <em>
 * Expr</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParamType#getLocation
 * <em>Location</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlParamType#getName <em>
 * Name</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType()
...
public interface ScxmlParamType extends EObject {
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType_ScxmlExtraContent()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see #setExpr(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType_Expr()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType_Location()
     ...
     * @see #setName(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType_Name()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlParamType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
