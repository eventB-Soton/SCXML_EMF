 ...
 * <li>{@link ac.soton.scxml.ScxmlLogType#getAny <em>Any
 * </em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlLogType#getExpr <em>
 * Expr</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlLogType#getLabel <em>
 * Label</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlLogType()
...
public interface ScxmlLogType extends EObject {
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlLogType_ScxmlExtraContent()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlLogType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * @see #setExpr(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlLogType_Expr()
     ...
     * @see #setLabel(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlLogType_Label()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlLogType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
