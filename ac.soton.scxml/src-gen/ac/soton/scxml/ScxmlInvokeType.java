 ...
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getContent
 * <em>Content</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getParam
 * <em>Param</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getFinalize
 * <em>Finalize</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getAny <em>
 * Any</em>}</li>
 * <li>
 * {@link ac.soton.scxml.ScxmlInvokeType#getAutoforward
 * <em>Autoforward</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getId <em>Id
 * </em>}</li>
 * <li>
 * {@link ac.soton.scxml.ScxmlInvokeType#getIdlocation
 * <em>Idlocation</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getNamelist
 * <em>Namelist</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getSrc <em>
 * Src</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getSrcexpr
 * <em>Srcexpr</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getType <em>
 * Type</em>}</li>
 * <li>{@link ac.soton.scxml.ScxmlInvokeType#getTypeexpr
 * <em>Typeexpr</em>}</li>
 * <li>
 ...
 * </p>
 *
 * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType()
...
public interface ScxmlInvokeType extends EObject {
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_ScxmlInvokeMix()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Content()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Param()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Finalize()
     * @model containment="true" transient="true" volatile="true" derived="true"
     *        extendedMetaData=
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Any()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
     ...
     * enumeration {@link ac.soton.scxml.BooleanDatatype}
     * . <!-- begin-user-doc -->
     * <p>
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Autoforward()
     ...
     * @see #setId(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Id()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Idlocation()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Namelist()
     ...
     * @see #setSrc(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Src()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Srcexpr()
     ...
     * @see #unsetType()
     * @see #setType(String)
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Type()
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_Typeexpr()
     * @model dataType="ac.soton.scxml.ValueLangDatatype"
     ...
     * @see ac.soton.scxml.ScxmlPackage#getScxmlInvokeType_AnyAttribute()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry"
